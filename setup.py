...
setup(
    ...
    license="LGPL",
    python_requires='>=3.5',
    install_requires=["nibabel==2.5.0", "numpy==1.15.1", "scipy==1.0.0", "pydicom==1.3.0", "matplotlib==3.0.3", "scikit-image==0.15.0", "simpleitk==1.2.2", "tensorflow-gpu==1.15.2", "torch==1.2.0", "torchvision==0.4.0", "visdom==0.1.8.9"],
    classifiers=[
